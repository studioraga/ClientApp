...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final IProfile profile = new ProfileDrawerItem().withName("Raja Mallik").withEmail("raja.mallik@gmail.com").withIcon("https://avatars1.githubusercontent.com/u/28018355?v=3&u=33eed4981e62406979b46d0f949527fef33f6900&s=400").withIdentifier(100);
                ...
                .withOnAccountHeaderListener(new AccountHeader.OnAccountHeaderListener() {
                    ...
                    public boolean onProfileChanged(View view, IProfile profile, boolean current) {
                        ...
                        if (profile instanceof IDrawerItem && profile.getIdentifier() == PROFILE_SETTING) {
                            ...
                            IProfile newProfile = new ProfileDrawerItem().withNameShown(true).withName("Minne" + count).withEmail("minne" + count + "@gmail.com").withIcon(R.drawable.profile5).withIdentifier(count);
...
//        firebaseDatabase.getReference("app_title").setValue("BlinkLed IoT Light");
